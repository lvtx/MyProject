...
namespace DriveDetailInfo
{
    public class Program
    {
        ...
        private static void ShowDriveDetail()
        {
            ...
            foreach(System.Management.ManagementObject disk in mos.Get())
            {
                ...
                Console.Write("Name: {0}", disk["Name"]);
                Console.WriteLine(disk["DriveType"]);
                Console.WriteLine("Caption: {0}",disk["Caption"]);
                Console.WriteLine("Description: {0}",disk["Description"]);
                Console.WriteLine("FileSystem: {0}", disk["FileSystem"]);
                Console.WriteLine("NumberOfBlocks: {0}", disk["NumberOfBlocks"]);
                Console.WriteLine("ProviderName: {0}", disk["ProviderName"]);
                Console.WriteLine("SystemName: {0}", disk["SystemName"]);
